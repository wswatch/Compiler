...
After doing above, there will be files that names "XXX.xml", "XXXT.xml"(if there is XXX.jack)
--------------------------------------------------------------------------------------------
Warning:
...
1. open the terminal
2. use "cd" to locate this file, for example if the address of this file in your computer is "/Users/shuaiwang/Desktop/project10", then input cd "/Users/shuaiwang/Desktop/project10"
...
1. It can change a jack language file into xml and tokens.
2. It will check if a jack language is reasonable. That is, it contains error detection. If a certain line does not follow the vm language's rule, it will stop the compile and tell you which line it is and the error this line have.
